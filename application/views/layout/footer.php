			...
			<div class="main-card mb-3 card">
				<div class="card-body">
					...
					<form class="">
						<div class="form-row">
							<div class="col-md-6">
								<div class="position-relative form-group"><label for="RaisonSociale"
									class="">Raison Sociale</label><input name="RaisonSociale"
									id="RaisonSociale" placeholder="Name of établissement" type="text"
									class="form-control">
								</div>
							</div>
							<div class="col-md-6">
					...
					<div class="position-relative form-group"><label for="Poste"
						...
						placeholder="fonction of the contact" type="text" class="form-control"></div>
						<div class="position-relative form-group col-md-6"><label for="Adresse"
							class="">Adresse</label><input name="Adresse" id="Adresse"
							placeholder="Apartment, studio, or floor" type="text" class="form-control">
						</div>
						<div class="position-relative form-group col-md-6"><label for="Department"
							class="">Department</label><input name="Department" id="Department"
							placeholder="Department" type="text" class="form-control">
						</div>
						<div class="form-row">
							<div class="col-md-6">
								...
								<div class="col-md-6">
									...
									<div class="col-md-6">
										<div class="position-relative form-group"><label for="NomduCommercial"
											class="">Nom
									...
									<div class="col-md-6">
										...
										<div class="col-md-8">
											<div class="position-relative form-group"><label for="notes"
												class="">Notes</label>
										...
										<div class="position-relative form-check"><input name="check" id="REFUS" type="checkbox"
											class="form-check-input"><label for="REFUS"
											class="form-check-label">REFUS</label>
										</div>
