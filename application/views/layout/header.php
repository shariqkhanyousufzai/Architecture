...
<head>
	...
	<title>Analytics Dashboar</title>
	<meta name="viewport"
			...
			<div class="header-btn-lg pr-0">
				...
				<div class="widget-content-left  ml-3 header-user-info">
					...
					<div class="widget-subheading">
						<?= ($this->session->userdata('group_id')) == 1 ? 'Admin' : 'Agent';?>
					</div>
				</div>
			</div>
		</div>
...
<div class="scrollbar-sidebar">
	<div class="app-sidebar__inner">
		<ul class="vertical-nav-menu">
			...
			<li>
				<a href="<?=base_url()?>" class="<?= ($this->uri->segment(1) == '') ? 'mm-active' : '' ?>">
					<i class="metismenu-icon pe-7s-rocket"></i>
					Dashboard
				</a>
			</li>
			<li>
				<a href="<?=base_url('customer/profile')?>" class="<?= ($this->uri->segment(2) == 'profile') ? 'mm-active' : '' ?>">
					<i class="metismenu-icon pe-7s-edit"></i>
					Edit Profile
				</a>
			</li>
			<li>
				<a href="<?=base_url('customer')?>" class="<?= ($this->uri->segment(1) == 'customer' && $this->uri->segment(2) == '') ? 'mm-active' : '' ?>">
					<i class="metismenu-icon pe-7s-users"></i>
					Customers List
				</a>
			</li>
			<li>
				<a href="<?=base_url('customer/map')?>" class="<?= ($this->uri->segment(2) == 'map') ? 'mm-active' : '' ?>">
					<i class="metismenu-icon pe-7s-map-marker"></i>
					Map Filter
				</a>
			</li>
			<li>
				<a href="<?=base_url('customer/activity')?>" class="<?= ($this->uri->segment(2) == 'activity') ? 'mm-active' : '' ?>">
